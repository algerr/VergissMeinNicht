...
class AccountEinstellungen extends Component {
    ...
    // Das modale Fenster zur Aktualisierung der Emailadresse wird geöffnet,
    ...
    // Das modale Fenster zur Änderung des Passwortes wird geöffnet,
    // wenn der Nutzer auf den entsprechenden Button drückt.
    onPasswortAendern = () => {
    ...
    // Das modale Fenster zum Löschen des Accounts wird geöffnet,
    // wenn der Nutzer auf den entsprechenden Button drückt.
    onAccountloeschen = () => {
...
// mapStateToProps ist eine Funktion, die den Redux Store auf den aktuellen Zustand des Komponenten abbildet.
// In diesem Fall wird nur das "token" aus dem "authentifizierung"-Slice des Stores extrahiert und als Prop an den Komponenten weitergegeben.
